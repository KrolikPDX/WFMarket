...
class ItemsInSetAdapter(private val context: Context?) : RecyclerView.Adapter<ItemsInSetAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // to inflate the layout for each item of recycler view.
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.cardview_item_in_set, parent, false)
    ...
    //Return total items in set for total grids in gridview
